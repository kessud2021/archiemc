...
export function LeaderboardSection({
  ...
  return (
    <BaseSection
      background="uhc"
      className="flex-col-reverse lg:flex-row justify-between items-center lg:py-0"
    >
      ...
      <div className="mx-4 lg:mx-0 flex flex-col gap-4 max-w-100 xl:max-w-150 text-mc-white text-center lg:text-start ">
        <h1 className="text-mc-4 lg:text-mc-7 break-words font-bold text-mc-yellow">
          Leader
          <wbr />
          boards
        </h1>
        <p className="text-mc-1.75 lg:text-mc-2 leading-6">
          ...
          game and stat. Try{" "}
          <Command command="/leaderboard uhc leaderboard: score" /> for an
          example.
        </p>
      </div>
    </BaseSection>
